package com.demo.test.testsomething;
/**
 * @author Rust Fisher
...
public class RomanAndInt {
    ...
    public static int romanToInt(String s) {  
        ...
        for (int i = 1; i < s.length(); i++) {  
            ...
            System.out.println("pre = "+pre+ "  current = "+current+"  temp = "+ temp + "  result = " + result);
            pre = current;  
        }  
        result += temp;  
        return result;  
    ...
    /**
     * com.demo.test.test main
     */
    public static void main(String args[]){
        System.out.println( "CIL = " + romanToInt("CIL"));
//        for (int i = 0; i < 4; i++) {
